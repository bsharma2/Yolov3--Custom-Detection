...
def train():
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if not opt.notest or final_epoch:  # Calculate mAP
            ...
            is_coco = any([x in data for x in ['coco.data']]) and model.nc == 80
...
if __name__ == '__main__':
    ...
    parser.add_argument('--img-size', nargs='+', type=int, default=[1024, 1024], help='[min_train, max-train, test] img sizes')
